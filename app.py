...
app = Flask(__name__)
app.secret_key = "super_secret_key_123"   # CAMBIAR

EXCEL_FILE = "registro_vehiculos.xlsx"
...
def modificar():
    ...
    # ¿Categoría nueva?
    if nombre not in conteos and nombre not in nuevas:
